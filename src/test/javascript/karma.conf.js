...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/popper.js/dist/umd/popper.js',
            'src/main/webapp/bower_components/js-cookie/src/js.cookie.js',
            'src/main/webapp/bower_components/moment/moment.js',
            'src/main/webapp/bower_components/sticky.js/dist/sticky.compile.js',
